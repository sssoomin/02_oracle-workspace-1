...
/*
    ...
    ALTER TALBE 테이블명 ADD UNIQUE(컬럼명);
    ALTER TABLE 테이블명 ADD CHECK(컬럼에대한조건식);
    ALTER TABLE 테이블명 MODIFY 컬럼명 NOT NULL;
*/

-- EMPLOYEE_COPY 테이블에 EMP_ID 컬럼에 PRIMARY KEY 제약조건 추가 
ALTER TABLE EMPLOYEE_COPY ADD PRIMARY KEY(EMP_ID);

-- EMPLOYEE 테이블에 DEPT_CODE 컬럼에 FOREIGN KEY 제약조건 추가(DEPARTMENT 참조)
ALTER TABLE EMPLOYEE ADD FOREIGN KEY(DEPT_CODE) REFERENCES DEPARTMENT(DEPT_ID);

-- EMPLOYEE 테이블에 JOB_CODE 컬럼에 FOREIGN KEY 제약조건 (JOB 참조)
ALTER TABLE EMPLOYEE ADD FOREIGN KEY(JOB_CODE) REFERENCES JOB;

-- DEPARTMENT 테이블에 LOCATION_ID 컬럼에 FOREIGN KEY 제약조건 (LOCATION 참조)
